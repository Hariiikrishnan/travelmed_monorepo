...
export default function BuyPage() {
    ...
    },
    {
      ...
      content: (
        <p className="text-xs md:text-sm leading-relaxed">
          All medications are individually blistered and sourced directly from DCGI approved over the counter medicine labs. Expiry dates are monitored and guaranteed for a minimum of 24 months from purchase.
        </p>
      )
    },
    {
  ...
  const buyFaqs = [
    {
      ...
      content: (
        <span>
          The kit includes <strong className="font-bold text-slate-900 dark:text-white">150+ DCGI & CDSCO-regulated medicines and essentials</strong> covering 17 critical categories (fever, food poisoning, acidity, allergies, pain, motion sickness, antibiotics, first aid, etc.) plus <strong className="font-bold text-slate-900 dark:text-white">2 FREE doctor teleconsultations</strong> and a signed physician prescription.
        </span>
      )
    },
    {
      id: 'buy-faq-2',
      title: "How do I use the 2 FREE doctor teleconsultations?",
      content: (
        <span>
          Inside your kit pouch, scan the high-resolution QR code or click your unique access link from your email receipt. You will be connected to a licensed physician in <strong className="font-bold text-slate-900 dark:text-white">under 3 minutes</strong> for live guidance.
        </span>
      )
    },
    {
      id: 'buy-faq-3',
      title: "Is the kit approved for airport security & customs?",
      content: (
        <span>
          <strong className="font-bold text-slate-900 dark:text-white">100% Yes.</strong> All solid blister-packed tablets, capsules, and band-aids adhere strictly to TSA, IATA, and international airport security guidelines. The included signed Doctor's Prescription matches all medicines inside.
        </span>
      )
    },
    {
      id: 'buy-faq-4',
      title: "What is the shelf life guarantee of the medicines?",
      content: (
        <span>
          We guarantee a minimum of <strong className="font-bold text-slate-900 dark:text-white">18 to 24 months shelf life</strong> on all medications from your delivery date. Every item features individual expiry stamps and English dosage instructions.
        </span>
      )
    },
    {
      ...
      content: (
        <span>
          Standard shipping takes <strong className="font-bold text-slate-900 dark:text-white">2-4 business days</strong> with FREE express delivery nationwide across India. Expedited next-day dispatch is available for tight travel dates.
        </span>
      )
    }
  ];
  ...
  return (
    <div className="flex flex-col min-h-screen font-sans bg-gradient-to-b from-[#DCEBFF] via-white to-[#EEF6FF] bg-fixed dark:bg-neutral-950">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
            ...
            <div className="lg:col-span-6 space-y-6">
                  ...
                  <button
                    ...
                    className={`w-20 h-20 rounded-2xl border overflow-hidden cursor-pointer transition ${
                      activeImageIdx === idx 
                        ...
                        : 'border-border/60 hover:border-border opacity-70'
                    }`}
                  >
              ...
              {/* Guarantees Ribbon */}
              <div className="p-6 bg-slate-50/50 dark:bg-neutral-900/40 rounded-2xl border border-border space-y-4">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h4 className="text-xs font-bold text-neutral-800 dark:text-neutral-200">Express Delivery</h4>
                      <p className="text-[11px] text-neutral-400">Dispatched within 24 hours in discreet thermal packaging.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-4 items-center text-[10px] text-neutral-400 font-semibold tracking-wider uppercase border-t sm:border-t-0 sm:border-l border-neutral-200/60 pt-3 sm:pt-0 sm:pl-6 w-full sm:w-auto">
                    ...
                    <span className="flex items-center gap-1"><Award className="h-4 w-4 text-[#14B8A6]" /> DGCI APPROVED</span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white/60 dark:bg-neutral-900/60 backdrop-blur-md rounded-2xl p-5 border border-blue-50/50 flex flex-col sm:flex-row items-center justify-between gap-4 select-none">
                <div className="flex items-center gap-3">
                  <div className="flex -space-x-2">
                    <img src="/doctor.webp" alt="Doctor" className="w-8 h-8 rounded-full border-2 border-white object-cover" />
      ...
      <section className="py-16 bg-transparent border-t border-border/40">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10">
          <div className="text-center space-y-3">
            ...
            <h3 className="text-2xl sm:text-3xl font-extrabold font-heading text-neutral-850 dark:text-neutral-100">
              Product & Purchase FAQs
            </h3>
            <p className="text-slate-500 dark:text-neutral-400 text-sm max-w-xl mx-auto">
              Everything you need to know before ordering your Travel Med Kit.
            </p>
          </div>

          <Accordion items={buyFaqs} defaultOpenId="buy-faq-1" />

          <div className="text-center pt-2">
            <Link href="/faq">
              <span className="inline-flex items-center gap-1.5 px-6 py-3 rounded-full text-xs font-extrabold border border-primary/30 text-primary hover:bg-primary hover:text-white transition-all duration-300 shadow-xs hover:shadow-md cursor-pointer">
                View All Help Center FAQs <ChevronRight className="h-4 w-4" />
              </span>
            </Link>
          </div>
        </div>
