              ...
              <Card hoverEffect={true} className="p-6 border-border bg-card shadow-sm space-y-4 text-left">
                ...
                <div className="pt-3 border-t border-border/40 grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs">
                  <div className="flex items-center gap-2">
                    ...
                    <a href="tel:+918148493389" className="font-extrabold text-primary hover:underline select-text whitespace-nowrap">
                      +91 81484 93389
                    </a>
                  </div>
                  <div className="flex items-center gap-2">
                    <span className="font-bold text-neutral-500">Email:</span>
                    <a href="mailto:sales@travelmed.org" className="font-extrabold text-primary hover:underline select-text whitespace-nowrap">
                      sales@travelmed.org
                    </a>
                  </div>
                </div>
